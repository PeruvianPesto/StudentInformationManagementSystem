...
CREATE TABLE `enrollments` (
  ...
  `status` enum('active','dropped','completed') DEFAULT NULL,
...
CREATE TABLE `sections` (
  ...
  CONSTRAINT `sections_ibfk_2` FOREIGN KEY (`teacher_id`) REFERENCES `teachers` (`teacher_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-05-23 15:54:07
